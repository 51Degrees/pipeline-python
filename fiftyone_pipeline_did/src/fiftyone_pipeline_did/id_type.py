...
class IdType(IntEnum):
    ...
    :attr:`PROBABILISTIC`. The type selects the length of the value that
    ...
    @classmethod
    def from_flags(cls, flags: int) -> "IdType":
        """Decodes the identifier type from the top two bits (6-7) of a flags
        byte.
        """
        return cls((flags >> 6) & 0b11)
